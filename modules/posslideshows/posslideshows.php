...
class Posslideshows extends Module implements WidgetInterface
{
    ...
    protected $default_pause_on_hover = 0;
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"special pizza recipe","display":"3","animation":"6"},"2":{"title":"Hot & Fresh","display":"0","animation":"7"},"3":{"title":"Premium","display":"0","animation":"8"},"4":{"title":"Pepperoni","display":"0","animation":"9"},"5":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"ramada pizza offers","display":"3","animation":"8"},"2":{"title":"Delicious","display":"0","animation":"9"},"3":{"title":"Pizza Bittes","display":"0","animation":"7"},"4":{"title":"Order Now","display":"0","animation":"6"},"5":{"title":"Shop Now","display":"5","animation":"10"}}';
				}else{
