...
class PosFeaturedProducts extends Module implements WidgetInterface{
    ...
    public function install() {
        ...
        Configuration::updateValue($this->name . '_per_lg', 2);
    ...
    {   
        ...
        $values['posfeaturedproducts_title'][(int)$id_lang] = '';
            ...
            $fields_form[0]['form'] = array(
                ...
                'input' => array(
                        ...
                        array(
                            ...
                            'name' => 'posfp_img',
                            'desc' => $this->l('Upload an image for your banner. The recommended dimensions are 690 x 928px.'),
                            'lang' => true,
                        ),
                        array(
                            'type' => 'text',
