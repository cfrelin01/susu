...
class PosThemeoptions extends Module implements WidgetInterface
{
    ...
    {
        //General
        Configuration::updateValue($this->name . 'g_main_color', '#cf2929');
        ...
        // Configuration::updateValue($this->name . 'g_a_colorh', '#cf2929');
        Configuration::updateValue($this->name . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Lobster&display=swap'); 
        Configuration::updateValue($this->name . 'g_title_gfont_name', '"Lobster", sans-serif');
        Configuration::updateValue($this->name . 'g_title_font_size', 42);
        ...
        Configuration::updateValue($this->name . 'g_title_font_size_column', 36);
        ...
        // Configuration::updateValue($this->name . 'g_button_bgcolorh', '#cf2929');
        ...
        // Configuration::updateValue($this->name . 'g_footer_a_colorh', '#cf2929');
        // Product
        Configuration::updateValue($this->name . 'p_display', 0);
        Configuration::updateValue($this->name . 'p_name_color', '#253237');
        Configuration::updateValue($this->name . 'p_name_colorh', '#cf2929');
        ...
        Configuration::updateValue($this->name . 'p_price_color', '#cf2929');
        Configuration::updateValue($this->name . 'p_price_size', 20);
        // Category page
        ...
        Configuration::updateValue($this->name . 'pp_price_color', '#253237');
    ...
    public function generateCss()
    {
        ...
        $css .='.pos_title h2{ 
		 ...
		 $css .='.cart-summary-line .value,.product-price,.blockcart .popup_cart .price_content .price_inline .value,.product-prices,#_desktop_contact_link .contact-link a,.desc_slideshow h2,.desc_slideshow h3,.desc_slideshow h4,.banner-box .txt_cms h3,
